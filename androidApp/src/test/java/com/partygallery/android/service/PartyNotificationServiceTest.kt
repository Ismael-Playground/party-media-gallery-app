...
class PartyNotificationServiceTest {
    ...
    fun testServiceInstantiation() {
        ...
        assertTrue(
            "Should be instance of PartyNotificationService",
    ...
    fun testServiceLifecycle() {
        ...
        assertTrue(
            "Service should extend Android Service class",
    ...
    fun testServiceConfiguration() {
        ...
        assertEquals(
            "Service class should have correct name",
            "PartyNotificationService",
            className,
        )
        ...
        assertTrue(
            "Should be in service package",
            packageName?.contains("service") == true,
        )

        // Verify service inheritance structure
        assertTrue(
            "Service should extend android.app.Service",
            android.app.Service::class.java.isAssignableFrom(service.javaClass),
        )
