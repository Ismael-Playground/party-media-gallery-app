...
data class ForgotPasswordState(
    ...
    val resetResult: ForgotPasswordResult = ForgotPasswordResult.Idle,
...
sealed class ForgotPasswordResult {
    ...
    data object EmailNotFound : ForgotPasswordResult()
    data object TooManyRequests : ForgotPasswordResult()
}
...
sealed class ForgotPasswordEvent {
    ...
    data object ShowEmailSent : ForgotPasswordEvent()
    data object ShowResendSuccess : ForgotPasswordEvent()
}
